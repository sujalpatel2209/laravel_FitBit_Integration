...
class Fitbit2Controller extends Controller
{
    public function auth2(){

        $provider = new Fitbit([
            'clientId'          => '228L83',
            'clientSecret'      => 'f43e0430d7832be16a522de7907f8a72',
            'redirectUri'       => 'http://localhost/laravelDemo/laravel_fitbit/public/success2'
        ]);
